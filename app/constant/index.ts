...
export const EXPERIANCE = [
  { title: 'Founder', subtitle: 'Onlink Solution (2023 onwards)', descrption: 'Founder at Software Company named Onlink Solutions started from 2022 as employee' },
  { title: 'Web Developer', subtitle: 'Ape Dee Events UK (2022 - 2024)', descrption: `While pursuring my degree, I was freelancing at Ape Dee Events as a Web Developer` },
]
...
export const PORTFOLIO = [
  ...
  { path: '/portfolio/project-11.jpg', title: 'Fears To Fathom Game Website', description: 'Featuring a sleek design and interactive elements, the site captures the eerie essence of the series, providing visitors with detailed insights into the episodes and their spine-tingling narratives.', link: 'https://fearstofathom.vercel.app/' },

  { path: '/portfolio/project-12.jpg', title: 'Spinner Energy Drink', description: 'I developed the official website for Spinner Energy Drink, focusing on a modern, responsive design that highlights the brand’s energy, products, and bold identity.', link: 'https://spinnerenergy.vercel.app/' },
]