    ...
    <section id='home'>
      <div className='main_container h-full md:h-screen flex items-center max-lg:mt-5'>
        <div className='mt-[5rem] grid md:grid-cols-2 items-center'>
          <div className='py-10 flex flex-col gap-6 lg:gap-5'>
            <h2 className='text-3xl text-white uppercase lg:text-5xl leading-tight'>I'm a<span className='text-hightlight'> Web developer </span> <br />
              & <span className='text-hightlight'> Cybersecurity enthusiast </span>based in sri lanka</h2>
            <p className='text-lg text-gray-300'>Hey, my name is <span className='text-hightlight'>Mohomed Fazil</span>, I like to craft solid and <br className='hidden sm:block' /> scalable frontend & backend products with great user experiences also passionate about web security and work as a penetration tester to help keep applications safe from vulnerabilities. </p>
            <div className='mt-5'>
