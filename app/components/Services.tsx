import { RiPencilRuler2Line, RiSmartphoneLine, RiWebhookLine } from '@remixicon/react'
    ...
    <section className='py-24' id='services'>
      <div className='main_container'>
        ...
        <div className='mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-3'>
          ...
          <article className='bg-bg py-16 px-8 rounded-xl group hover:bg-hightlight duration-700 transition-all'>
            <div>
              <FileCode2 className='bg-hightlight rounded-full w-14 h-14 p-2 group-hover:bg-black group-hover:text-hightlight text-black' />
              <div className='mt-5 grid gap-4'>
                <h3 className='font-poppins text-xl font-bold group-hover:text-black'>Web Penetration Tester</h3>
                <p className='group-hover:text-black'>I help businesses identify and fix security vulnerabilities in their websites before hackers can exploit them using ethical hacking techniques</p>
              </div>
            </div>
          </article>
        </div>
